					...
					<div class="card-body">
						<form role="form" method="post" action="modify.do" name="modifyForm">
							...
							<div class="form-group">
								...
								<input type="text" id="title" name='title' class="form-control" value="${fn:escapeXml(notice.title) }">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<textarea class="form-control" name="content" id="content" rows="3"
									placeholder="500자 내외로 작성하세요.">${fn:escapeXml(notice.content)}</textarea><!-- summernote자체에서 div를 해주기때문에 div로 안해도 됨. -->				
							</div>
						</form>
					</div><!--end card-body  -->
