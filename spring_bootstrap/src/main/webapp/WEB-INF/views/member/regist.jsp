				...
				<div class="register-card-body">
					<form role="form" class="form-horizontal" action="regist.do" method="post">						
						...
						<div class="card-footer">
							<div class="row">								
								<div class="col-sm-6">
									<button type="submit" id="registBtn" onclick="regist_go();return false;" class="btn btn-info">등&nbsp;&nbsp;록</button>
							 	</div>
...
function idCheck_go(){
	...
	if(!input_ID.val){
		...
		if(!reqID.test($('input[name="id"]').val())){ //검사는 test로 정규식.test(타입 , 맞으면 true, 틀리면 false)
