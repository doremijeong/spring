...
<head>
  ...
  <title><!-- <decorator:title default="MemberManagement"/> -->MJ system</title>
...
<div class="wrapper" style="max-width: 1280px;">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">MamberManagement</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
	        ...
	        <a href="emailto:${loginUser.email }">email : ${loginUser.email }</a>
        </div>
      </div>
	  </c:if>
      <!-- Sidebar Menu -->
